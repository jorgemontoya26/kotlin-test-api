...
typealias ApplicationUser = com.minisocial.minisocialapi.model.User

@Service
class CustomUserDetailsService(private val userRepository: UserRepository) : UserDetailsService {
    override fun loadUserByUsername(username: String): UserDetails =
        userRepository.findByEmail((username))?.mapToUserDetails() ?: throw UsernameNotFoundException("Not found!")
